...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YMKStylingRoadEvents",
            url: "https://maps-ios-pods-public.s3.yandex.net/YMKStylingRoadEvents-4.39.1.framework.zip",
            checksum: "0238171a0f824f5ce7f22171eba1ae829cd0b2a1233a36dea7c6bb14688ad09e"
        ),
        .target(
