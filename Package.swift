...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YMKStylingRoadEvents",
            url: "https://maps-ios-pods-public.s3.yandex.net/YMKStylingRoadEvents-4.15.0.framework.zip",
            checksum: "002bc8d2d4f79b4a7d4c7b3f592d63d4591a9bda698d9c3fba88c61ed34bf225"
        ),
        .target(
