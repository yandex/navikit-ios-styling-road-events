...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YMKStylingRoadEvents",
            url: "https://maps-ios-pods-public.s3.yandex.net/YMKStylingRoadEvents-4.32.1.framework.zip",
            checksum: "1cf84c84232ab2028dc60ed37ddfd38eaedb65585fb9b6ae40a2d649685691fb"
        ),
        .target(
