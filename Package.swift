...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "YMKStylingRoadEvents",
            url: "https://maps-ios-pods-public.s3.yandex.net/YMKStylingRoadEvents-4.14.1.framework.zip",
            checksum: "f2a8999de89e718e2750add4bf1e772b391aed77df261a0c0b817f1940db790b"
        ),
        .target(
